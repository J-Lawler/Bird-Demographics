...
\begin{titlepage}
  \vspace*{.5em}
  \center
  \textbf{\Large{The University of Edinburgh}} \\
  \textbf{\Large{ }} \\
  \textbf{\Large{School of Mathematics}} \\
  \vspace*{1em}
  \begin{figure}[!h]
  \centering
  ...
  \end{figure}
  \vspace{2em}
  \textbf{\Huge{Estimating Intra and Inter-Winter Survival Probabilities in Passerines}}\\[2em]
  \textbf{\LARGE{by}}\\
  \vspace{2em}
  ...
  \Large{August 2023}\\
  \vspace{3em}
  \Large{Supervised by\\Dr Ruth King and Dr Cecilia Balocchi}
  \vfill
\end{titlepage}
%
\clearpage
